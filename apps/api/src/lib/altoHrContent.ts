...
2.3  Timekeeping — Alto People. All time must be recorded through the Alto People clock-in system (worksite kiosk or mobile application). The Associate must be physically present at their assigned client worksite when clocking in. The system records the device's GPS location where available; clock-ins recorded outside the assigned worksite area are flagged for review by Alto HR and may be adjusted or disallowed after investigation. Where the Associate has separately consented, the kiosk may also capture a photograph at each punch to verify identity. Alto HR does not accept paper timesheets or verbal time reporting. Timesheets not submitted within thirty (30) days of the work week are not eligible for payment and the fees for those hours are forfeited.
