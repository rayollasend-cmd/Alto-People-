// Gap 11 â€” Phase 8: Form 1099-MISC plain-paper renderer.
//
...
//
//   Copy A â€” For Internal Revenue Service Center
//   Copy 1 â€” For State Tax Department
//   Copy B â€” For Recipient
...
function drawFooter(doc: PDFKit.PDFDocument, data: Form1099MiscPdfData): void {
  ...
  doc
    ...
    .fillColor('#666')
    .text(
      `Form 1099-MISC (${data.taxYear})  Â·  Copy ${variant}  Â·  ID ${data.meta.formId.slice(0, 8)}  Â·  ` +
