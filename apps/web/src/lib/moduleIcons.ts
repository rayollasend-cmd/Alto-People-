...
export const MODULE_ICONS: Record<ModuleKey, LucideIcon> = {
  ...
  'portal-today': UsersIcon,
  'portal-ops': ClipboardCheck,
  'floor-today': UsersIcon,
  ...
  'fieldglass': FieldglassIcon,
  'fieldglass-setup': FieldglassSetupIcon,
  'me': UserCircleIcon,
