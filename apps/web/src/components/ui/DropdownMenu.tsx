...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      'px-2 py-1.5 text-2xs uppercase tracking-widest text-silver',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Separator
    ref={ref}
    className={cn('-mx-1 my-1 h-px bg-navy-secondary', className)}
    {...props}
  />
));
...
export const DropdownMenuShortcut = ({
  ...
  <span
    className={cn('ml-auto text-2xs tracking-widest text-silver/80', className)}
    {...props}
  />
);

// Submenu trigger w/ chevron — re-exported in case we want nested menus.
...
>(({ className, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      'focus:bg-navy-secondary focus:text-white data-[state=open]:bg-navy-secondary',
      className
    )}
    {...props}
  >
    {children}
    <ChevronRight className="ml-auto h-4 w-4 text-silver/70" />
  </DropdownMenuPrimitive.SubTrigger>
));
